   ...
   if(session.getAttribute("comN") != null)
   {
    ...
    if( logID == "") {%>
          <ul>
            ...
            <li style = "display : inline-block;"><p onclick="login();">로그인</p></a></li> 
          </ul>
   <% }else{ %>    
...
<!-- 로그인 모달 창 -->
   <article id="login" class="overlay">
      ...
      <article class="popup">
         ...
         <a href="" onclick="modalClose();" class="close">&times;</a>
         <!--회원가입으로 이동-->
...
<!--!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!-->
<script>
const loginbody = document.querySelector('.overlay');

function login(){
   console.log("ㅋ");
    loginbody.style.visibility='visible'; // 모달 창 띄우기
}
function modalClose(){// 모달창 꺼질 때
